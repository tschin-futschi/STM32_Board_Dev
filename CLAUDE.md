...
| I2C（电机） | I2C1, PB6/PB7, AF4 | `BSP_I2C1_` | APB1, 400 kHz 默认 |
| I2C（PMIC） | I2C3, PA8/PC9, AF4 | `BSP_I2C3_` | APB1, PMIC RT5112WSC |
...
### I2C1（`bsp_i2c1.c`）— 电机 IC

- 引脚：PB6(SCL) / PB7(SDA)，AF4，400 kHz
